...
export var renderTextField = function (_a) {
    var label = _a.label, input = _a.input, _b = _a.meta, asyncValidating = _b.asyncValidating, touched = _b.touched, invalid = _b.invalid, error = _b.error, helperText = _a.helperText, custom = __rest(_a, ["label", "input", "meta", "helperText"]);
    ...
    return (React.createElement(TextField, __assign({ label: label, 
        ...
        InputProps: {
            ...
            style: { fontSize: "16px" }
        }, error: touched && invalid, helperText: (touched && t(error)) || helperText }, input, custom)));
};
