...
export var renderTextField = function (_a) {
    var label = _a.label, input = _a.input, _b = _a.meta, asyncValidating = _b.asyncValidating, touched = _b.touched, invalid = _b.invalid, error = _b.error, custom = __rest(_a, ["label", "input", "meta"]);
