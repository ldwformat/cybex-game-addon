...
var mapDispatchToAction = function (dispatch) {
    return {
        postChange: function (isShowPoster) {
...
var InviteBtnPC = /** @class */ (function (_super) {
    ...
    InviteBtnPC.prototype.render = function () {
        ...
        return (React.createElement("div", { ref: function (wrapper) { return (_this.wrapper = wrapper); }, style: {
            ...
            React.createElement(Fab, { onClick: this.props.postChange.bind(this, !this.props.isShowPoster), 
                // color="secondary"
            ...
            React.createElement(Poster, { open: this.props.isShowPoster, onClose: this.props.postChange.bind(this, !this.props.isShowPoster), posterLink: accountReferUrl, filename: "cybex_invite_" + accountName + ".png" })));
    };
    return InviteBtnPC;
}(React.Component));
var MapInviteBtnPC = connect(mapPropsToState, mapDispatchToAction)(InviteBtnPC);
