...
export var Notifier = connect(mapStateToProps, mapDispatchToProps)(withSnackbar(/** @class */ (function (_super) {
    ...
    class_1.prototype.componentDidUpdate = function () {
        var _this = this;
        var _a = this.props.notifications, notifications = _a === void 0 ? [] : _a;
        notifications.forEach(function (notification) {
            ...
            _this.props.enqueueSnackbar(notification.message, notification.options);
