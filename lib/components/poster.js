...
export var PosterDisplay = withTranslation()(/** @class */ (function (_super) {
    ...
    function class_1() {
        ...
        _this.updateQRImg = function () { return __awaiter(_this, void 0, void 0, function () {
            var posterBase64, posterImg, posterCanvas, posterCtx, posterSpace, canvas, QRCode, oriPosterImg, codeWrapper, domedCodeWrapper, codeImg;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, import("./../assets/images/poster").then(function (poster) { return poster[_this.props.t(Dict.Poster)]; })];
                    case 1:
                        posterBase64 = _a.sent();
                        ...
                        posterSpace = findFirstEmptyZone(posterCtx, posterCanvas.width, posterCanvas.height);
                        if (!posterSpace) {
                        ...
                        posterSpace;
                        return [4 /*yield*/, import("./../utils/qrcode").then(function (_a) {
