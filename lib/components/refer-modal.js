...
export var ReferModalForm = /** @class */ (function (_super) {
                ...
                return (React.createElement("form", { onSubmit: handleSubmit },
                    React.createElement(DialogContent, { style: styleOfContent },
                        React.createElement("div", { style: { marginBottom: "1em" } },
                            React.createElement(Field, { autoFocus: true, style: { width: "100%" }, component: renderTextField, name: "referrer", label: "\u63A8\u8350\u7801", helperText: "\u8BF7\u8F93\u5165\u63A8\u8350\u4EBA\u5206\u4EAB\u7ED9\u60A8\u7684\u63A8\u8350\u7801" }))),
                    React.createElement(DialogActions, { style: { margin: "8px 12px" } },
                        React.createElement(PrimaryButton, { color: "primary", fullWidth: true, type: "submit", disabled: pristine || submitting || invalid }, "\u589E\u52A0\u63A8\u8350\u4EBA"))));
            } }));
    };
