...
import { selectRegCaptcha, authRegGetCaptcha } from "../core/auth";
...
export var RegForm = withToolset(reduxForm({
...
})(connect(mapStateToProps, mapDispatch)(/** @class */ (function (_super) {
    ...
    RegForm.prototype.render = function () {
        var _this = this;
        var _a = this.props, handleSubmit = _a.handleSubmit, pristine = _a.pristine, submitting = _a.submitting, invalid = _a.invalid, getCaptcha = _a.getCaptcha, captcha = _a.captcha;
        var styleOfContent = {
            width: "80%",
            minWidth: "60vw",
            padding: 0,
        ...
        return (React.createElement("form", { onSubmit: handleSubmit },
            React.createElement(DialogContent, { style: styleOfContent },
                ...
                React.createElement("div", { style: { marginBottom: "0.5em" } },
                    React.createElement(Field, { style: { width: "100%" }, component: renderTextField, name: "confirm", label: "\u786E\u8BA4\u5BC6\u7801", helperText: "\u518D\u6B21\u8F93\u5165\u60A8\u7684\u5BC6\u7801", type: this.state.showConfirm ? "text" : "password", InputProps: {
                            endAdornment: (React.createElement(InputAdornment, { position: "end" },
                                React.createElement(IconButton, { onClick: function () {
                                        return _this.setState(function (prev) { return ({
                ...
                React.createElement("div", { style: { marginBottom: "0.5em" } },
                    React.createElement(Field, { style: { width: "100%" }, component: renderTextField, name: "captcha", type: "text", label: "\u9A8C\u8BC1\u7801", helperText: "\u8BF7\u8F93\u5165\u53F3\u4FA7\u9A8C\u8BC1\u7801", InputProps: {
                            endAdornment: (React.createElement(InputAdornment, { position: "end" }, captcha && (React.createElement(SVGInline, { svg: captcha.data, onClick: getCaptcha }))))
                        } }))),
