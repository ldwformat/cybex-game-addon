...
import { ReferState, refer, loadReferInfoEpic, addReferEpic, addReferAfterLoginEpic } from "./refer";
import { GatewayState, gateway, loadDepsoitInfoEpic, loadDpstAfterSelAssetEpic, loadGatewayInfoEpic } from "./gateway";
import { CybexAssistant } from "../utils/cybex-assistant";
import { WsConnection } from "../utils/connect";
var loggerMiddleware = createLogger();
// RootState
var CoreState = /** @class */ (function () {
    function CoreState(game) {
        this.game = game;
...
export { CoreState };
var rootEpic = combineEpics(loginEpic, loadCountriesEpic, loadProvincesEpic, loadReferInfoEpic, loadDepsoitInfoEpic, loadDpstAfterSelAssetEpic, loadGatewayInfoEpic, addReferEpic, addReferAfterLoginEpic);
...
export var configureStore = function (config) { return function (preloadState) { return __awaiter(_this, void 0, void 0, function () {
    var _a, cybexWs, cybexHttpServer, mallBackend, referBackend, gateway, backend, wsConnect, epicMiddleware, store;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = config.apiUrl, cybexWs = _a.cybexWs, cybexHttpServer = _a.cybexHttpServer, mallBackend = _a.mallBackend, referBackend = _a.referBackend, gateway = _a.gateway, backend = _a.backend;
