...
import { loginEpic, loginCloseEpic, loginFailedEpic, updateBalanceEpic, authUpdateBalanceEpic } from "./auth";
...
var rootEpic = combineEpics(loginEpic, loginCloseEpic, loginFailedEpic, loadCountriesEpic, loadProvincesEpic, loadReferInfoEpic, loadDepsoitInfoEpic, loadDpstAfterSelAssetEpic, authUpdateBalanceEpic, updateBalanceEpic, loadGatewayInfoEpic, addReferEpic, addReferAfterLoginEpic, notifierEpic);
export var configureStore = function (config) { return function (preloadState) { return __awaiter(_this, void 0, void 0, function () {
    var _a, cybexWs, cybexHttpServer, mallBackend, referBackend, gateway, backend, wsConnect, notifier, toolset, epicMiddleware, store;
