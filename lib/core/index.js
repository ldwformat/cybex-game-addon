...
import { loadReferInfoEpic, addReferEpic, addReferAfterLoginEpic, addRefFailedEpic } from "./refer";
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                store = createStore(rootReducer, preloadState, applyMiddleware(
                // loggerMiddleware,
                epicMiddleware));
