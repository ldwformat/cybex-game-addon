...
var PrivateKey = /** @class */ (function () {
    ...
    PrivateKey.fromSeed = function (seed) {
        ...
        return PrivateKey.fromBuffer(sha256(seed, undefined));
    };
    ...
    PrivateKey.fromWif = function (_private_wif) {
        ...
        var new_checksum = sha256(private_key, undefined);
        new_checksum = sha256(new_checksum, undefined);
    ...
    PrivateKey.prototype.toWif = function () {
        ...
        var checksum = sha256(private_key, undefined);
        checksum = sha256(checksum, undefined);
    ...
    /** ECIES */
    PrivateKey.prototype.get_shared_secret = function (public_key, legacy) {
    ...
    PrivateKey.prototype.child = function (offset) {
        ...
        offset = sha256(offset, undefined);
