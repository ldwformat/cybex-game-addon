...
export var DepositModal = withToolset(connect(mapStateToProps, mapDispatchToProps)(withStyles(styles)(withTranslation()(/** @class */ (function (_super) {
    ...
    function class_1() {
        ...
        _this.updateFee = debounce(function () {
            var currentAsset = _this.props.currentDeposit;
            if (!currentAsset) {
                return _this.setState({ fee: 0 });
            }
            var currentCoinInfo = _this.props.currentCoinInfo;
            var memo = _this.state.address;
            if (currentCoinInfo) {
                memo = currentCoinInfo.raw.withdrawPrefix + ":" + currentCoinInfo.currency + ":" + _this.state.address;
            }
            _this.props.toolset.chainAssisant.getFakeTransferFee(currentAsset.asset, memo).then(function (res) { return __awaiter(_this, void 0, void 0, function () {
            ...
            this.state.currentTab === 1 && (React.createElement(Paper, { classes: { root: classes.root }, square: true, elevation: 0 },
                React.createElement(Grid, { className: classes.innerWrapper, container: true, direction: "column", alignItems: "center" },
                    ...
                    React.createElement(FormControl, { fullWidth: true },
                        ...
                        React.createElement(Input, { id: "withValue", placeholder: t(Dict.WithdrawMinimum), value: this.state.withValue, style: { fontSize: "16px" }, type: "number", onChange: function (e) {
                                _this.setState({ withValue: e.target.value });
                    ...
                    React.createElement(Grid, { container: true, wrap: "nowrap" },
                        React.createElement(FormControl, null,
                            ...
                            React.createElement(Input, { disabled: true, disableUnderline: true, id: "minWithdraw", value: currentCoinInfo && currentCoinInfo.raw.minWithdraw, style: { fontSize: "16px", marginTop: "30px" } })),
                        React.createElement(FormControl, null,
                            React.createElement(InputLabel, { style: { fontSize: "17.5px", lineHeight: "20px" }, htmlFor: "withdrawFee" }, t(Dict.WithdrawalFee)),
                            React.createElement(Input, { disabled: true, disableUnderline: true, id: "withdrawFee", value: currentCoinInfo && currentCoinInfo.raw.withdrawFee, style: { fontSize: "16px", marginTop: "30px" } })),
                        React.createElement(FormControl, null,
                            React.createElement(InputLabel, { style: { fontSize: "17.5px", lineHeight: "20px" }, htmlFor: "transferFee" }, t(Dict.TransferFee)),
                            React.createElement(Input, { disabled: true, disableUnderline: true, id: "transferFee", value: this.state.fee, style: { fontSize: "16px", marginTop: "30px" } })),
                        React.createElement(FormControl, null,
                            React.createElement(InputLabel, { style: { fontSize: "17.5px", lineHeight: "20px" }, htmlFor: "withdrawFee" }, t(Dict.YouWillGet)),
                            React.createElement(Input, { disabled: true, disableUnderline: true, id: "withdrawFee", value: Math.max(0, this.state.withValue -
                                    (currentCoinInfo
                                        ...
                                        : this.state.withValue)), style: { fontSize: "16px", marginTop: "30px" } }))),
