                ...
                React.createElement(Grid, { className: classes.innerWrapper, container: true, direction: "column", alignItems: "center" },
                    ...
                    React.createElement(FormControl, { fullWidth: true },
                        ...
                        React.createElement(Input, { id: "withValue", placeholder: t(Dict.WithdrawMinimum), value: this.state.withValue, style: { fontSize: "16px" }, onChange: function (e) {
                            ...
                            }, endAdornment: React.createElement(InputAdornment, { position: "end" }, "balance:" + balance.value) })),
                    React.createElement(FormControl, { fullWidth: true },
                    ...
                    React.createElement(Grid, { container: true, wrap: "nowrap" },
                        React.createElement(FormControl, null,
                            React.createElement(InputLabel, { style: { fontSize: "17.5px" }, htmlFor: "minWithdraw" }, t(Dict.WithdrawMinimum)),
                            React.createElement(Input, { disabled: true, disableUnderline: true, id: "minWithdraw", value: currentCoinInfo && currentCoinInfo.raw.minWithdraw, style: { fontSize: "16px" } })),
                        React.createElement(FormControl, null,
                        ...
                        React.createElement(FormControl, null,
                            React.createElement(InputLabel, { style: { fontSize: "17.5px" }, htmlFor: "transferFee" }, t(Dict.TransferFee)),
                            React.createElement(Input, { disabled: true, disableUnderline: true, id: "transferFee", value: this.state.fee, style: { fontSize: "16px" } })),
                        React.createElement(FormControl, null,
