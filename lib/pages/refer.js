                ...
                React.createElement("div", { style: { flex: "1 1 auto", overflowY: "auto" } },
                    ...
                    React.createElement(List, null,
                        React.createElement(ListItem, { divider: true },
                            React.createElement(ListItemText, { primary: t(Dict.MyRegisterReferrer) }),
                            (myRegisterReferrer && myRegisterReferrer.referrer) || "-"),
                        React.createElement(ListItem, { divider: true },
                            React.createElement(ListItemText, { primary: t(Dict.MyGameReferrer) }),
                            (myGameReferrer && myGameReferrer.referrer) || (React.createElement(Button, { color: "secondary", onClick: this.handleExpand.bind(this, Refer.Panels.ReferModal) }, t(Dict.PatchReferrer)))),
