...
export var cnDict = {
    ...
    RefererRuleContent_2: "<strong>【返现总额】</strong>将显示您所有返现的总额，并折合成USDT方便显示计算，数据会进行实时更新，如您有任何问题，请及时反馈给CybexBet小助手（微信号：cybexgame-1)。",
    PeopleUnit: "人",
    CopyAddress: "复制地址",
...
export var enDict = {
    ...
    RefererRuleContent_2: "<strong>Total Return Cash</strong> will show the total amount of your all asset cash backs converted into USDT for the convenience. The data will be updated in real time. Any questions, please give feedback to CybexBet assistant. (Wechat: cybexgame-1)",
...
export var vnDict = {
    ...
    RefererRuleContent_1: "<strong>Tổng tiền hoàn lại</strong> sẽ hiển thị tổng số tiền hoàn lại của bạn và chuyển đổi thành USDT để tính toán hiển thị. Dữ liệu sẽ được cập nhật theo thời gian thực. Nếu bạn có bất kỳ câu hỏi nào khác, xin vui lòng gửi phản hồi cho các trợ lý CybexBet (Wechat: cybexgame-1).",
