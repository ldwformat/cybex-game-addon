...
describe("测试资产精度相关工具函数", function () {
    var assetName = "CYB";
    var asset;
    var fetcher = new ChainFetcher("wss://hangzhou.51nebula.com", "");
    beforeAll(function (done) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetcher.fetchAsset(assetName)];
                case 1:
                    asset = _a.sent();
                    done();
                    return [2 /*return*/];
