                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, this.getFeeOfOp("transfer", ops.transfer.toObject({
                                ...
                                memo: memoStr ? CybexAssistant.encodeMemo(memoStr, PrivateKey.fromSeed("0000000000000000000000"), PrivateKey.fromSeed("0000000000000000000000").toPublicKey().toString()) : undefined
                            }), assetID)];
                }
            });
        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _asset = (_a.sent())[0];
                        assetID = _asset && _asset.id;
                        opID = typeof opNameOrID !== "number" ? ChainTypes.operations[opNameOrID] : opNameOrID;
