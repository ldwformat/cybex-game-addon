...
var CybexAssistant = /** @class */ (function () {
    ...
    CybexAssistant.prototype.transfer = function (_a, keyStore) {
        var from = _a.from, to = _a.to, asset = _a.asset, value = _a.value, memo = _a.memo;
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0: return [4 /*yield*/, this.getAccounts(from, to).then(function (accounts) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 6:
                        e_1 = _a.sent();
                        if (!(retry++ === 0)) return [3 /*break*/, 8];
                        return [4 /*yield*/, this.wsConnect.connect()];
                    case 7:
                        _a.sent();
                        return [2 /*return*/, tr.broadcast()];
                    case 8: return [2 /*return*/, e_1];
