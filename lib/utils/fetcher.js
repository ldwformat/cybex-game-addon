...
import { query_address, set_address, set_refer } from "../cybex/serializer/src/operations";
var simpleCache = {};
var getKey = function () {
    var args = [];
...
var ReferFetcher = /** @class */ (function () {
    ...
    ReferFetcher.prototype.getRebateDetails = function (account, action) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.fetch("rebate/?account=" + account + "&action=" + action)];
            });
        });
    };
    return ReferFetcher;
...
var GatewayFetcher = /** @class */ (function () {
    ...
    GatewayFetcher.prototype.fetch = function (path, token) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    GatewayFetcher.prototype.getCoinList = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.fetch("assets").then(function (res) {
                        return res.map(function (info) {
                            return ({
                                asset: info.cybname,
                                currency: info.name,
                                raw: info,
    ...
    GatewayFetcher.prototype.getDepositInto = function (accountName, coinType, privKey) {
        return __awaiter(this, void 0, void 0, function () {
            var url, timeStamp, token;
            return __generator(this, function (_a) {
                url = "users/" + accountName + "/assets/" + coinType + "/address";
                timeStamp = Math.floor(new Date().getTime() / 1000).toString();
                token = Signature.signBuffer(Buffer.from(timeStamp + accountName), privKey).toHex();
                return [2 /*return*/, this.fetch(url, timeStamp + "." + accountName + "." + token).then(function (res) {
                        return ({
    ...
    GatewayFetcher.prototype.verifyAddress = function (coinType, address) {
        return __awaiter(this, void 0, void 0, function () {
            var url;
            return __generator(this, function (_a) {
                url = "assets/" + coinType + "/address/" + address + "/verify";
                return [2 /*return*/, this.fetch(url).then(function (res) {
                        return ({
                            coinType: coinType,
                            address: address,
                            valid: res.valid
...
var FaucetFetcher = /** @class */ (function () {
    function FaucetFetcher(faucetUrl) {
        this.faucetUrl = faucetUrl;
    }
    FaucetFetcher.prototype.fetch = function (path, body) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, fetch(resolvePath(this.faucetUrl, path), {
                        headers: {
                            "Content-Type": "application/json"
                        },
                        method: "post",
    ...
    FaucetFetcher.prototype.getCaptcha = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, fetch(resolvePath(this.faucetUrl, "captcha")).then(function (res) { return res.json(); })];
            });
        });
    };
    FaucetFetcher.prototype.postRegistInfo = function (regInfo) {
        return __awaiter(this, void 0, void 0, function () {
            var body;
            return __generator(this, function (_a) {
                body = regInfo;
                return [2 /*return*/, this.fetch("register", body)];
            });
        });
    };
    return FaucetFetcher;
}());
export { FaucetFetcher };
var PriceFetcher = /** @class */ (function () {
    function PriceFetcher(priceUrl) {
        if (priceUrl === void 0) { priceUrl = "https://app.cybex.io/price"; }
        this.priceUrl = priceUrl;
    }
    PriceFetcher.prototype.fetchPrices = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, fetch(this.priceUrl)
                        .then(function (res) { return res.json(); })
                        .then(function (res) {
                        if (res.code !== 0) {
                            throw new Error("400");
