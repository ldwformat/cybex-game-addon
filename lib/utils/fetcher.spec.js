...
describe("Test class ReferFetcher", function () {
    ...
    it("测试增加引荐人", function (done) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    setRefer = fetcher.setRefer(accountName, "harley", "alltokenbet", privKey);
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 5]);
    ...
    it("测试增加注册引荐人", function (done) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    setRefer = fetcher.setRegisterRefer(accountNameOne, "harley", "alltokenbet", privKeyOne);
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 5]);
                    return [4 /*yield*/, expect(setRefer).resolves.toBeUndefined()];
...
describe("Test class GatewayFetcher", function () {
    ...
    it("测试获取ETH地址", function (done) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetcher.getDepositInto(accountName, "ETH", privKey)];
                case 1:
                    depositRes = _a.sent();
                    if (depositRes !== null) {
                        expect(depositRes.accountName).toBe(accountName);
                        expect(depositRes.address).toBe("0xf204095acc62c5b65e991729417d170512f9c8c8");
    ...
    it("测试获取不存在资产地址", function (done) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetcher.getDepositInto(accountName, "ETH.NOT.EXISTS", privKey)];
                case 1:
                    depositRes = _a.sent();
    ...
    it("测试获取不存在用户地址", function (done) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetcher.getDepositInto("ETH.NOT.EXISTS", "ETH.NOT.EXISTS", privKey)];
                case 1:
                    depositRes = _a.sent();
                    expect(depositRes).toBeNull();
                    done();
...
describe("测试Rebate接口", function () {
    var fetcher;
    var accountName = "g5188";
    var action = "bet";
    beforeAll(function () { return (fetcher = new ReferFetcher(config.apiUrl.referBackend)); });
    test("取得Bet接口明细", function (done) { return __awaiter(_this, void 0, void 0, function () {
        var rebate;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetcher.getRebateDetails(accountName, action)];
                case 1:
                    rebate = _a.sent();
                    console.log(rebate);
