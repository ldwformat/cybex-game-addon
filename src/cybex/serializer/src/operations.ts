...
export let void_ext = new Serializer("void_ext");
...
const cybex_ext_swap = new Serializer("cybex_ext_swap", {
  cybex_ext_swap: string
});
const cybex_ext_xfer_to_name = new Serializer("cybex_ext_xfer_to_name", {
  name: string,
  asset_sym: string,
...
const cybex_xfer_item = new Serializer("cybex_xfer_item", {
  name: string,
  amount: string
});
const cybex_ext_xfer_to_many = new Serializer("cybex_ext_xfer_to_many", {
...
export const participate_crowdfund = new Serializer("participate_crowdfund", {
  fee: asset,
...
export const withdraw_crowdfund = new Serializer("withdraw_crowdfund", {
  fee: asset,
  buyer: protocol_id_type("account"),
  crowdfund_contract: protocol_id_type("crowdfund_contract")
});
export const initiate_crowdfund = new Serializer("initiate_crowdfund", {
  fee: asset,
