...
export const cnDict = {
  ...
  CopyShareLinkPrefix:
    "我正在AllToken Bet参与高奖金竞猜游戏！邀请您来参与！点击链接即可注册：",
  ShareLink: "分享邀请",
  ...
  WithdrawImportantFee:
    "提现手续费将以您希望取出的目标资产支付，从您的提取金额中扣除。",
  Balance: "余额",
  Login: "登录",
  Unlock: "解锁",
  Register: "注册",
...
export const enDict: Dictionary = {
  ...
  CopyShareLinkPrefix:
    "I am participating in the quiz game with high bonus at AllTokenBet！Join us now！Click the link to register:",
  ...
  WithdrawImportantFee:
    "Withdrawal fee will be deducted by the target asset from the withdrawal amount.",
  Balance: "Balance",
...
export const vnDict: Dictionary = {
  ...
  CopyShareLinkPrefix:
    "Tôi đang tham chơi Casino tại AllToken Bet! Hãy đến tham gia cùng tôi nào! Nhấp vào liên kết để đăng ký:",
  ...
  WithdrawImportantAddress:
    "Chỉ hỗ trợ địa chỉ USDT được cung cấp cho chuỗi OMNI；",
  WithdrawImportantFee:
    "Phí rút tiền sẽ được khấu trừ bởi tài sản mục tiêu từ số tiền rút.",
  Balance: "Số dư",
